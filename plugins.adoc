...
The plugin defines the following extra properties, that may be used for platform specific behavior. This functionality will soon be removed from this plugin in favour of the platform plugin.
